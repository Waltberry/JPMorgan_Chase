# Submission Script for Task 1
# Submited by Onyero Walter Ofuzim
...
def plot_prices(data):
    ...
    plt.ylabel('Price')
    plt.grid(True)
    plt.savefig('historical_prices.png')  # Save the plot as an image file
    print("Prices plot saved as 'historical_prices.png'!")
...
def analyze_seasonality(data):
    ...
    plt.savefig('seasonality.png')  # Save the plot as an image file
    print("Seasonality plot saved as 'seasonality.png'!")
...
def extrapolate_future_prices(data, months=12):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('extrapolated_prices.png')  # Save the plot as an image file
    print("Extrapolated prices plot saved as 'extrapolated_prices.png'!")
...
if __name__ == "__main__":
    ...
    estimated_price = estimate_price(data, '2022-05-15')
